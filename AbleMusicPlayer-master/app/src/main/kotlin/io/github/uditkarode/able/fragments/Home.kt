...
class Home : Fragment(), CoroutineScope, MusicService.MusicClient {
    ...
    companion object {
        ...
        private const val TRENDING_CACHE_TIME_MS = 6 * 60 * 60 * 1000
    }
    ...
    private fun setupRecyclerViews() {
        ...
        binding.songs.apply {
            ...
            adapter = songAdapter
            ItemTouchHelper(SwipeController(context, "Home", mService, songAdapter)).attachToRecyclerView(this)
        }
    ...
    private fun loadTrendingSongs() {
        ...
        if (currentTime - lastTrendingUpdateTime < TRENDING_CACHE_TIME_MS) return
        ...
        launch(Dispatchers.IO) {
            val playSong = {
                ...
                try {
                    ...
                    val ext = stream.getFormat()?.suffix ?: "webm"
                            ...
                            .listener(object : RequestListener<Bitmap> {
                                override fun onResourceReady(
                                    ...
                                    resource?.let {
                                        ...
                                        if (freshStart) {
                                            MusicService.registeredClients.forEach { it.serviceStarted() }
                                        }
                                    }
                                    return false
                                }
